...
const COLORS = ['#FF7F50', '#1890ff', '#52c41a'];

const NewUserStatsPieChart = () => {
  ...
  const loading = dayStats.loading || weekStats.loading || monthStats.loading;
  const error = dayStats.error || weekStats.error || monthStats.error;
...
export default NewUserStatsPieChart;
